...
resource sqlServerFirewallRule 'Microsoft.Sql/servers/firewallRules@2021-08-01-preview' = {
  parent: sqlServer
...
resource sqlDatabase 'Microsoft.Sql/servers/databases@2021-08-01-preview' = {
  ...
  location: location
  sku: environmentConfigurationMap[environmentType].sqlDatabase.squ
}
